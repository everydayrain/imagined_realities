...
Then create a folder under the user you've designated for ftp, give it `r+w` permissions and make sure its owned by that user.  Then add the following to the  `/etc/vsftpd.conf` file.
